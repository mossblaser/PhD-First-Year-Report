\chapter{Preliminary Work}
	...
	\section{Interconnect Modelling}
		...
		\subsection{Results}
			...
			\subsubsection{Na\"ive Routing Effects}
				...
				\begin{figure}
					...
					\caption{Heat-map of average packet latency to each chip from the
					central chip. Note: a skewed perspective is used.}
				...
				\begin{figure}
					...
					\caption{Latency to each chip from the central chip (24,24) to a section
					of a $48\times{}48$ system. The serial latency in this system has been
					exaggerated to aid visibility but the effect is still present with
					realistic latencies.}
		...
		\subsection{Conclusions}
			...
			% TODO: Crossref for future simulator
