		...
		\subsection{Routing}
			...
			\subsubsection{Multicast}
				...
				\begin{table}
					...
					\begin{tabular}{c c c}
						\toprule
							Route & Packet Hops & Router Entries \\
						\midrule
							(a) & 5 & 4 \\
							(b) & 4 & 5 \\
							(c) & 4 & 4 \\
				...
				\ref{tab:multicast-route-metrics}. For example, figures (b) - (d) are
				all optimal in the total number of `hops' required while (a), (c) and
				(d) are optimal in the number of routing entries required.
